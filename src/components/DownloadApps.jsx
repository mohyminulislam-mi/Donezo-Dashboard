...
const DownloadApps = () => {
  return (
    <Reveal>
      <div className="mx-6 p-4 bg-[#0A0D0B] rounded-3xl relative group">
        <div className="relative z-10 flex flex-col items-start">
          ...
          <button className=" flex items-center justify-center gap-2 bg-[#14532d] text-white w-full py-4 rounded-full font-bold shadow-md cursor-pointer">
            Download
          </button>
        </div>
      </div>
